...
export const books = mysqlTable("books", {
  ...
  reorderQuantity: int("reorder_quantity").default(50),
  schoolId: varchar("school_id", { length: 36 }),
});
...
export const bookLevels = mysqlTable("book_levels", {
  id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
  name: text("name").notNull(),
  description: text("description"),
  schoolId: varchar("school_id", { length: 36 }),
...
export const bookLevelItems = mysqlTable("book_level_items", {
  id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
...
export const classBookLevels = mysqlTable("class_book_levels", {
  id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
...
export const childLinkingCodes = mysqlTable("child_linking_codes", {
  id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
...
export const childBookBaskets = mysqlTable("child_book_baskets", {
  id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
...
export const bookPayments = mysqlTable("book_payments", {
  id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
  parentIdentifier: text("parent_identifier").notNull(),
...
export const basketPayments = mysqlTable("basket_payments", {
  id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
  basketId: varchar("basket_id", { length: 36 }).references(() => childBookBaskets.id, { onDelete: "cascade" }).notNull(),
  paymentId: varchar("payment_id", { length: 36 }).references(() => bookPayments.id, { onDelete: "cascade" }).notNull(),
});

export const financeBookAllocations = mysqlTable("finance_book_allocations", {
  id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
  studentId: varchar("student_id", { length: 36 }).references(() => students.id).notNull(),
  bookId: varchar("book_id", { length: 36 }).references(() => books.id).notNull(),
...
export const bookInventoryTransactions = mysqlTable("book_inventory_transactions", {
  id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
  bookId: varchar("book_id", { length: 36 }).references(() => books.id, { onDelete: "cascade" }).notNull(),
...
export const extraCopyRequests = mysqlTable("extra_copy_requests", {
  id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
