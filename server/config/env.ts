...
const schema = z.object({
  ...
  // Least-privilege read-only connection for the BytHub support console.
  // It is optional: when absent, console database browsing is unavailable.
  // The console never falls back to the application's privileged DATABASE_URL.
